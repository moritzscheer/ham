<nav>
    <div id="navbar">
        ...
        <div id="<?php echo $_SESSION["profileHeader"]?>" class="desktop create">
            <form action="createEvent.php">
                <input type="submit" value="create" id="navbar-button">
            </form>
        </div>

        <div id="<?php echo $_SESSION["normalHeader"]?>" class="desktop login">
        ...
        <div id="<?php echo $_SESSION["profileHeader"]?>" class="mobile dropdown dropdownProfile">
    ...
    <div id="content-profile" class="Header-Content">
        <div id="<?php echo $_SESSION["normalHeader"]?>">
            <form action="profile/register.php">
                <input type="submit" value="Sign Up" id="navbar-button">
            </form>
        </div>
        ...
        <div id="<?php echo $_SESSION["profileHeader"]?>">
