...
<nav>
    ...
    <div>
        <form action="inMeinerNähe.php" class="header">
            <input type="submit" value="In meiner Nähe" class="navbar-button">
        </form>
    </div>
    <div>
    ...
    <div >
        <form action="profilBearbeiten.php" class="header">
            <input type="submit" value="Profil Bearbeiten" class="navbar-button">
        </form>
    </div>
</nav>